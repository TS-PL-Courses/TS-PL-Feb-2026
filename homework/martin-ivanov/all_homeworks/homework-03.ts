...
let colorArray: string[] = ['red', 'blue', 'green', 'yellow', 'purple', 'orange', 'white', 'black'];
...
for (let i = 0; i < phoneNumber.length; i++) {
  let oldPhone = phoneNumber[i];
  let newPhone = '+359' + oldPhone.slice(1);
  console.log('Original:', oldPhone);
...
if (sick) {
  ...
  console.log('The activity is "watch a movie"');
} else if (money >= 20) {
  console.log('The activity is: "go to the cinema"');
} else {
  console.log('The activity is "go to the park"');
}
// Step 3: Log the person's details and the decided activity

// Exercise 6: Use an Enum, Object type, and Arrays
console.log('Use an Enum, Object type, and Array');
...
// Exercise 7:
console.log('Fix the following code to print the same message each time the function is called');
...
// Exercise 8:
console.log('Fix the errors in the code below');
...
console.log(names('Ivan', 'Petrov', 'Georgiev'));
console.log(names('Ivan', 'Petrov'));
...
function nameAge(firstName: string, lastName: string, age: number) {
