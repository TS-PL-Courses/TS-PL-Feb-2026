...
const employee = new Employee('Toshe');

console.log(employee.getName());

employee.changeName('Alexander');
...
class CarRental {
  ...
  public rentCar(days: number): string {
    const totalCost = days * this.costPerDay;
...
console.log(`Chair 1: Type - ${chair1.getType()}, Legs - ${chair1.getLegs()}`);

const chair2 = new Chair('Oakwood');
console.log(`Chair 2: Type - ${chair2.getType()}, Legs - ${chair2.getLegs()}`);
