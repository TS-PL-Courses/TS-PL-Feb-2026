...
console.log(
  `Name: ${namee}, Hour: ${hour}, Money: ${money}, Is Sick: ${isSick}, Activity: ${activity}`,
);
...
for (let i = 0; i < clients.length; i++) {
  console.log(
    `Name ${clients[i].name} Account Type : ${AccountType[clients[i].accountType]} : ${clients[i].accountType}`,
  );
}
// Exercise 7:
