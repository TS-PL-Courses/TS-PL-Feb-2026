...
let itemsArray: string[] = ['red', 'blue', 'green', 'yellow', 'purple', 'orange', 'white', 'black'];
...
printNames('Moshten', 'Extension', 'Baby');
printNames('Moshten', 'Extension');
 ...
 */
function printNamesAndAge(firstName = 'Moshten', lastName = 'Extension', age = 0) {
  if (firstName === 'Moshten' || lastName === 'Extension' || age === 0) {
    return `${firstName} ${lastName}, ${age}. Missing one or all arguments - first name, last name, or age`;
  }
  return firstName + lastName + age;
}

console.log(printNamesAndAge('Gosho', 'OtPochivka', 5));
console.log(printNamesAndAge('Gosho', 'OtPochivka'));
console.log(printNamesAndAge('Gosho'));
...
favoriteProgrammingLanguage('Extension', 'it is very moshten');
...
upperLowerCaseCalculation('MoshtenExtension');
