...
// npx ts-node homework-04-stateva.ts
...
class Chair extends Furniture {
  ...
  printDetails(): void {
    console.log(`Chair: Type - ${this.type}, Legs - ${this.legs}`);
  }
}

const chair1 = new Chair();
const chair2 = new Chair('Oakwood', 4);
...
// ========================================
// Run async exercises in order
// ========================================

async function runAsyncExercises() {
  console.log('=============== Exercise 7:===============');
  const result7 = await waitTwoSeconds();
  console.log(result7);
