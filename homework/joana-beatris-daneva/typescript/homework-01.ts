...
const isEven: boolean = myNumber % 2 === 0;
...
const positiveNumber: number = 4;
const isPositive: boolean = positiveNumber > 0;

if (isPositive) {
  console.log('My number is positive');
} else {
  console.log('My number is not positive');
}
...
const isEmpty: boolean = myString.length === 0;
