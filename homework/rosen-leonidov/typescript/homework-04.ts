// npx ts-node homework/rosen-leonidov/typescript/homework-04.ts
...
const employee = new Employee('Ivan Petrov');
...
employee.changeName('Georgi Ivanov');
...
// Step 1: Use the "waitTwoSeconds" function from Exercise 7.
