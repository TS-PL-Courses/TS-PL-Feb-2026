// npx ts-node typescript/introduction.ts
...
// block variable
let myNumber: number; // declare (initialize) variable
...
/**
 * This is a documentation comment used to describe the purpose of a function or
 * class method, their parameters and return values.
 */
function myFunction() {
  // code block
}
...
// if, else   Marks a block of statements to be executed on a condition
// switch, case, break   Marks a block of statements to be executed in different cases
